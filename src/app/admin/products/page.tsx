    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex justify-end gap-3 mb-4">
        <Link
          ...
          className="bg-gray-400 hover:bg-gray-600 text-white py-2 px-4 rounded-sm font-semibold"
        >
          お問い合わせ一覧
        </Link>
        <Link
      ...
      <div className="shadow-lg rounded-lg overflow-hidden">
        <table className="min-w-full leading-normal">
          <thead>
            <tr className="bg-gray-200 text-gray-700 texr-left">
              <th className={tableStyle}>ID</th>
              <th className={tableStyle}>商品名</th>
              <th className={tableStyle}>価格</th>
