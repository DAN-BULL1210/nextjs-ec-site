...
export default function Home() {
    ...
    fetch('/api/products/home')
      ...
      .then(data => {
       ...
       /* if (Array.isArray(data)) {
          ...
          // dataが { products: [ ... ] } の形なら、その中身をセット
          setProducts(data.products);
        } else {
          // それ以外（エラーレスポンスなど）なら空配列をセット
          console.error('APIのレスポンスが配列ではありませんでした:', data);
          setProducts([]);
        }
      })*/
  ...
  return (
    <div className="min-h-screen font-family: var(--font-geist-sans);">
      {message && (
